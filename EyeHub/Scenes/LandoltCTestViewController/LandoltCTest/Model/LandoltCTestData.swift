...
enum TransformPosition: CGFloat {
    case degree0
    case degree90
    case degree180
    case degree270
...
enum LandoltCTestData: CGFloat {
    ...
    static let allCases: [LandoltCTestData] = [.feet70, .feet60, .feet50, .feet40, .feet30, .feet20, .feet15, .feet10, .feet7, .feet4]
